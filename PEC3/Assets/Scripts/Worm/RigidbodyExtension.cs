...
namespace Dweiss
{
    ...
    {
        public static Vector3[] CalculateMovement(this Rigidbody2D that,
               ...
               int stepCount, float timeBeteenStep, Vector3 addedSpeed, Vector3 addedForce)
        {
            ...
            var v = (that.isKinematic == false ? that.velocity : Vector2.zero);// + addedSpeed + addedV;
            var a = (that.isKinematic == false ? Physics.gravity : Vector3.zero);
        ...
        ////////Doesn't supports 
        public static Vector3[] CalculateTime(this Rigidbody2D that, Vector3 targetPos)
        {
        ...
        public static Vector3[] CalculateTime(this Rigidbody2D that, Vector2 targetPos, 
            Vector2 addedSpeed, Vector2 addedForce)
        {
            ...
            var x0 = new Vector2(that.transform.position.x, that.transform.position.y);
            //x = x0 +vt + .5*a*t^2
        ...
        public static Vector2 PointMul(this Vector2 v1, Vector2 v2)
        {
            return new Vector2(v1.x*v2.x, v1.y*v2.y);
        }
        public static Vector2 PointMul(this Vector3 v1, Vector3 v2)
        {
            return new Vector2(v1.x * v2.x, v1.y * v2.y);
        }

        public static Vector2 PointDiv(this Vector2 v1, Vector2 v2)
        {
            return new Vector2(v1.x / v2.x, v1.y / v2.y);
        }
